    ...
    return {
        ...
        resolveId(id, importer) {
            if (isUtsModuleRoot(id)) {
                return (0, uni_cli_shared_1.requireResolve)(id, (importer && path_1.default.dirname(importer)) || process.env.UNI_INPUT_DIR);
            }
        },
...
function isUtsModuleRoot(id) {
    const parts = (0, uni_cli_shared_1.normalizePath)(id).split('/');
