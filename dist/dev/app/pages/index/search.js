...
(() => {
  ...
  // dist/dev/.nvue/pages/index/search.js
...
${codeFrame}` : message);
  ...
  function createComposer(options = {}) {
    ...
    const _locale = (0, import_vue2.ref)(__root && _inheritLocale ? __root.locale.value : isString(options.locale) ? options.locale : "en-US");
    const _fallbackLocale = (0, import_vue2.ref)(__root && _inheritLocale ? __root.fallbackLocale.value : isString(options.fallbackLocale) || isArray(options.fallbackLocale) || isPlainObject(options.fallbackLocale) || options.fallbackLocale === false ? options.fallbackLocale : _locale.value);
    ...
    function normalize(values) {
      return values.map((val2) => isString(val2) ? (0, import_vue2.createVNode)(import_vue2.Text, null, val2, 0) : val2);
    }
  ...
  ({
    ...
    setup(props, context) {
      ...
      return () => {
        ...
        return isString(props.tag) ? (0, import_vue2.h)(props.tag, assignedAttrs, children) : isObject$2(props.tag) ? (0, import_vue2.h)(props.tag, assignedAttrs, children) : (0, import_vue2.h)(import_vue2.Fragment, assignedAttrs, children);
      };
    }
  });
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("scroll-view", {
          ...
          (0, import_vue4.createVNode)(__easycom_8, null, {
            default: (0, import_vue4.withCtx)(() => [
              ...
              result.value.length === 0 ? ((0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(__easycom_6, {
                key: 0,
                showBtn: false,
                subTitle: "\u8BF7\u91CD\u65B0\u8F93\u5165\u5173\u952E\u8BCD"
              ...
              (0, import_vue4.createCommentVNode)(' <tm-cell showAvatar :round="3" :titleFontSize="30" title="\u884C\u52A8\u652F\u6301" rightText="\u770B\u5E7F\u544A\u8D5A\u79EF\u5206">\r\n			<template v-slot:avatar>\r\n				<tm-icon color="orange" :font-size="38" name="tmicon-heart-fill"></tm-icon>\r\n			</template>\r\n		</tm-cell> '),
  ...
  var search = /* @__PURE__ */ _export_sfc(_sfc_main4, [["__file", "D:/Code/app/tmui-cli-zscg/src/pages/index/search.nvue"]]);
