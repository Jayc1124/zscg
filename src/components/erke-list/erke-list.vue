		...
		<view :id="'good'+good.id" class="good-li" v-for="good in list" :key="good.id">
			...
			<tm-sheet :margin="[5, 5]">
				...
				<view class="flex-row flex-row-center-start">
					...
					<tm-image preview :width="300" :round="2" :height="200" :src="good.logo"></tm-image>
	<view class="pl-16 flex-1" style="width:0px">
		<tm-tag text :shadow="0" color="blue" size="m"  icon="tmicon-tag-fill" :label="good.category" style="margin-bottom: 10upx;">
		</tm-tag>
			<tm-tag text :shadow="0" color="green" size="m" icon="tmicon-position-fill" :label="good.orgName" style=""></tm-tag>
		
				</view>
					<!-- 	<tm-text _class="text-overflow-2" style="margin-bottom: 10upx;" :label="good.orgName"></tm-text> -->
				</view>
				<view class="flex flex-row flex-row-top-end">
					<tm-tag text :shadow="0" icon="tmicon-rank" color="pink"  size="m" :label="add(good.hours)"
											style=""></tm-tag>
										...
										<tm-tag text :shadow="0" icon="tmicon-weixinzhifu" color="orange" size="m"
											:label="format1(good.statusAll)" style=""></tm-tag>
									
									
					<tm-tag text :shadow="0" icon="tmicon-clock-fill" color="purple" size="m"
											:label="getDateDiff(good.endTime)" style=""></tm-tag>
				</view>
