				...
				<view class="one_box">
					...
					<view class="top3">
						<view class="num_two">
							...
							<view class="top_sy">网通·18000<span>活跃值</span></view>
						</view>
					</view>
					...
					<view class="top3">
						<view class="num_one">
							...
							<view class="top_sy">电子·18000<span>活跃值</span></view>
						</view>
					</view>
					...
					<view class="top3">
						<view class="num_three">
							...
							<view class="top_sy">软工·17500<span>活跃值</span></view>
						</view>
					</view>
				</view>
				...
				<view class="number_sy_box">
					...
					<view class="number_sy_main">
						<view style="width: 50%; text-align: center; border-right: 1px solid #eee;">
							<view class="number_num1">11350</view>
							<view class="danwei">平均活跃值</view>
						</view>
						<view style="width: 50%; text-align: center; z-index: 9999;">
							<view class="number_num2">76.8%</view>
							<view class="danwei">在线率</view>
						</view>
			...
			<view class="rankList_box">
				<view class="rankItem" v-for="(item,index) in rankList" :key="index">
					...
					<view class="NameBox">
						...
						<view class="color_ccc">{{item.city}} ｜ <text class="text-blue">{{item.salary}}</text>活跃值</view>
					</view>
