...
<template>
  <view class="about">
	...
	<view class="titleZ text-center align-center">
		<text class="text-bold">关于开发者</text>
		
		<view class="contentZ">
		<!-- 	<text class="text-xl text-bold">谢谢你的使用</text> -->
			<text class="text-xl">1、掌上成工由19级的网络工程萌新开发</text>
			<br>
			<text class="text-xl">2、开发人员:JayCPLB</text>
			<br>
			<text class="text-xl">3、推客校园</text>
	...
	<view class="titleZ text-center align-center margin-top-xl">
		<text class="text-bold">掌上成工公众号</text>
		<view class="contentZ margin-top-lg">
			<text class="text-xl text-bold" >服务号:推客校园</text>
			<br>
			<text class="text-xl text-bold">公众号:CDTU口袋君</text>
			<br>
    ...
    <button class='' open-type="contact">
      <image src='' class='share-img png round shadow-lg bg-white' mode='aspectFit'>
      </image>
    </button>
  </view>
</template>
...
<script>
  import LikeFx from '@/common/likeFx/likeFx.vue'
  export default {
    components: {
      LikeFx
    },
