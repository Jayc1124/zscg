	...
	<view>
		...
		<view class="cu-bar bg-white margin-top-xs">
			<view class="action sub-title">
				<text class="text-xl text-bold text-blue text-shadow">认证情况</text>
		...
		<view class="cu-bar bg-white margin-top-xs">
			<view class="action sub-title">
				<text class="text-xl text-bold text-blue text-shadow">用户新增统计</text>
		...
		<view class="cu-bar bg-white margin-top-xs">
			<view class="action sub-title">
				<text class="text-xl text-bold text-blue text-shadow">用户分布</text>
	...
	export default {
		data() {
			return {
				...
				// 雷达图
				radar: {
					categories: ['网通', '材环', '计算机', '电子工程学院', '经管', '大数据与人工智能'],
					series: [{
						name: '熟悉度',
				...
				Area: {
					...
					series: [{
						name: '19级',
						data: [100, 80, 200, 300, 112, 250, 560],
						color: '#facc14'
					}, {
						name: '20级',
						data: [70, 110, 300, 100, 400, 68, 780],
						color: '#2fc25b'
					}, {
						name: '21级',
						data: [35, 160, 120, 156, 200, 156, 690],
						color: '#1890ff'
					}]
				}
