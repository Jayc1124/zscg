...
<template>
	<view>
		<view class="cu-bar bg-white ">
			...
			<view class="action">
				<button class="cu-btn bg-blue shadow" @click="start(1)" data-target="Modal">{{index == 1 ? '关闭':'开启'}}</button>
			</view>
		</view>
		<view class="cu-bar bg-white ">
			<view class="action">
			...
			<view class="action">
				<button class="cu-btn bg-blue shadow"  @click="start(2)" data-target="Modal">{{index == 2 ? '关闭':'开启'}}</button>
			</view>
		</view>
		<view class="cu-bar bg-white ">
			<view class="action">
			...
			<view class="action">
				<button class="cu-btn bg-blue shadow"  @click="start(3)" data-target="Modal">{{index == 3 ? '关闭':'开启'}}</button>
			</view>
		</view>
		...
		<view class="cu-bar bg-white ">
			...
			<view class="action">
				<button class="cu-btn bg-blue shadow"  @click="start(4)" data-target="Modal">{{index == 4 ? '关闭':'开启'}}</button>
			</view>
		</view>
